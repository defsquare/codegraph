...
export const javaProfile: Profile = {
  ...
  notes: [
    ...
    "noClasspath resolution rate, measured (M2 audit): 98.9% on apache/commons-lang (263 files, 134944 type references, 1466 unresolved) and 77.0% on spring-petclinic (30 files, 2211 references, 509 unresolved). The rate is a property of the corpus's DEPENDENCY SURFACE, not of the extractor: commons-lang depends on nothing but the JDK, which resolves against the runner's own classpath, while petclinic's Spring/JPA dependencies are absent and every reference to them fails. Read the rate as \"how much of this corpus's world is on the classpath\"; a single target number across corpora is not meaningful.",
