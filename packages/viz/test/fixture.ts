  ...
  const city = {
    ...
    districts: [
      ...
      },
      {
        ...
        footprintDemand: 4,
        bounds: { x: 1, y: 8, width: 6, depth: 5 },
      },
      {
    ...
    buildings: [
      {
        id: "java:com.acme.order.deep/Util",
        name: "Util",
        kind: "class",
        isStub: false,
    ...
    districtArrows: [
      {
        from: "java:com.acme.order",
        to: "java:com.acme.order.deep",
        count: 3,
        kinds: ["invokes"],
        provenances: ["declared"],
        inferred: false,
      ...
      {
        from: "java:com.acme.web",
        to: "java:com.acme.order",
        count: 2,
        kinds: ["invokes"],
        provenances: ["declared", "derived"],
        inferred: true,
