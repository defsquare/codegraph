...
Codegraph extracts a dependency model from sources alone, with no build, and lets you query it, walk it as a 3D city, browse every dependency to its source line, replay its history, and have it explained bottom-up. The [landing page](https://codegraph.dev/) says why; these pages say how.
...
The [first tutorial](/tutorials/first-city/) walks through every step.
