...
fold](/explanation/analysis-pipeline/) does. Buildings are the nodes of the
...
- [Tutorial: reading a city](/tutorials/reading-the-city/) — districts, arcs,
  stub buildings, the legend.
- [How to build a complexity city](/how-to/complexity-city/) — binding height to
  a measure the extractor emits.
- [Reference: city metrics](/reference/city-metrics/) — the built-ins, the open
  forms, the scales.
- [Reference: city.json](/reference/artifacts/city-json/) — the artefact's shape.
- [How to colour by Spring role](/how-to/spring-roles/) — an opt-in inference,
  legended as one.
