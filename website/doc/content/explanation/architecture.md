...
the contract is [flat lines of JSON](/explanation/why-jsonl/) rather than a
...
- [How to install](/how-to/install/) — building the workspace, and why the
  frontends need a build before `--serve` works.
- [The city is a model](/explanation/city-is-a-model/) and
  [the navigator](/explanation/navigator/) — the split, twice, in detail.
- [Why the interchange is a line-based file](/explanation/why-jsonl/).
- [Explaining bottom-up](/explanation/explaining-bottom-up/) — the pure/impure
  seam around the model calls.
- [Reference: the CLI](/reference/cli/) — the one package that does I/O.
