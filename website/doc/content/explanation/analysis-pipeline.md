...
This is the same rule the [extraction side](/explanation/extracting-without-compiling/)
...
output. The per-command surface is in the [CLI reference](/reference/cli/).
...
inferences](/explanation/facts-vs-inferences/); it is mentioned here because it
...
- [Reference: the CLI](/reference/cli/) and
  [`analyze`](/reference/cli/analyze/) — the commands this pipeline serves.
- [How to get a facts-only view](/how-to/facts-only-view/) — views, in practice.
- [How to gate a pipeline](/how-to/ci-gate/) — the conformance gate and the
  cycle report's exit code.
- [How to export diagrams](/how-to/export-diagrams/) — what solid, dashed and
  `<<stub>>` mean in a rendered graph.
- [Reference: exit codes](/reference/exit-codes/) — the findings contract.
