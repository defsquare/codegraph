...
- [Facts and inferences never mix](/explanation/facts-vs-inferences/)
- [`codegraph analyze`](/reference/cli/analyze/)
- [Provenance reference](/reference/metamodel/provenance/)
- [Stubs reference](/reference/metamodel/stubs/)
