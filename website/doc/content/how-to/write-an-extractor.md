...
- [`model.jsonl` reference](/reference/model-jsonl/)
- [Language profiles reference](/reference/profiles/)
- [`codegraph validate`](/reference/cli/validate/)
- [Why JSONL](/explanation/why-jsonl/)
- [Identity is a natural key](/explanation/identity/)
