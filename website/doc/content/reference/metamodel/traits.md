...
See [Measures and literals](/reference/metamodel/measures-literals/).

## The composition that motivates the design

A Clojure var holding a function is simultaneously named, a value holder, and invocable: `traits: [TNamed, TStructural, TInvocable]`. No tree-shaped hierarchy can place it; trait composition expresses it directly. The argument is in [Why traits](/explanation/why-traits/).
...
The keys each contributes on the wire are listed under [`model.jsonl`](/reference/model-jsonl/#e).
