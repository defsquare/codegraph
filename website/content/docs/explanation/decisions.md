...
- Schema library, marker traits, profile equality, `space`, trait keys —
  [why traits](/docs/explanation/why-traits/) and
  [reference: profiles](/docs/reference/metamodel/profiles/).
- Identity, key separators, the module component, lineage over time —
  [identity is a key](/docs/explanation/identity/).
- The interchange, `children`, closure, the chunked reader, trait-set interning,
  SQLite — [why the interchange is a line-based file](/docs/explanation/why-jsonl/)
  and [reference: model.jsonl](/docs/reference/model-jsonl/).
- Stub containment and the Java extractor —
  [extracting without compiling](/docs/explanation/extracting-without-compiling/) and
  [reference: the Java extractor](/docs/reference/java-extractor/).
...
- Measures, literal values, annotation usage, DI wiring —
  [facts and inferences](/docs/explanation/facts-vs-inferences/) and
  [reference: measures and literals](/docs/reference/metamodel/measures-literals/).
