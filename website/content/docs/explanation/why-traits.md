...
[the metamodel reference](/docs/reference/metamodel/traits/) as such. It is worth
...
The idea is not ours. It is [FamixNG](/docs/explanation/prior-art/)'s, from the
...
- [Reference: traits](/docs/reference/metamodel/traits/) — the full vocabulary, with
  the attributes each trait contributes.
- [Reference: profiles](/docs/reference/metamodel/profiles/) and the
  [nine shipped profiles](/docs/reference/profiles/) — the validation rule and the
  per-kind tables.
...
- [Prior art](/docs/explanation/prior-art/) — Moose and FamixNG, and what codegraph
  took from them.
