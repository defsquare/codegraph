...
|---|---|
| [`validate`](/docs/reference/cli/validate/) | any model has findings, or the load was not clean |
| [`analyze`](/docs/reference/cli/analyze/) | the load was not clean; and for `--report cycles`, whenever any strongly connected component exists |
| [`import`](/docs/reference/cli/import/) | the load was not clean; the store is still written |
| [`export`](/docs/reference/cli/export/) | the load was not clean; the artifact is still written |
| [`city`](/docs/reference/cli/city/) | the load was not clean; the city is still built |
| [`navigator`](/docs/reference/cli/navigator/) | the load was not clean; the artifact is still written |
| [`domain-facts`](/docs/reference/cli/domain-facts/) | the load was not clean; the artifact is still written |
| [`explain`](/docs/reference/cli/explain/) | the load was not clean, or any unit failed to be explained |
| [`snapshots`](/docs/reference/cli/snapshots/) | any sampled revision failed to extract; the successful frames stay in the store |
| [`history`](/docs/reference/cli/history/) | the input file is not a `history.jsonl` |
| [`scm`](/docs/reference/cli/scm/), [`timeline`](/docs/reference/cli/timeline/), [`replay`](/docs/reference/cli/replay/), [`profiles`](/docs/reference/cli/profiles/) | never |

"The load was not clean" means the union the command read produced diagnostics: a schema error, a closure violation, a self-edge, a profile violation, or a conflicting redeclaration across models. Run [`validate`](/docs/reference/cli/validate/) on the same paths for the detail.
