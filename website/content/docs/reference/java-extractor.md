...
See [Stubs](/docs/reference/metamodel/stubs/) and [Extracting without compiling](/docs/explanation/extracting-without-compiling/).

## Measures emitted

Carried in the `TMetrics` map. See [Measures and literals](/docs/reference/metamodel/measures-literals/).
