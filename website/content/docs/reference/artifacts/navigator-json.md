...
The browsable shape of a corpus: a tree of modules, types and members, plus one classified dependency row per base edge. Written by [`navigator`](/docs/reference/cli/navigator/).
...
The design behind one classified row per base edge: [The navigator](/docs/explanation/navigator/).
