...
see [Facts and inferences](/docs/explanation/facts-vs-inferences/).
...
- [Replaying a project's history](/docs/tutorials/history-replay/) — the dependency
  the source cannot show you: what changes together.
- [Querying the model with SQL](/docs/tutorials/sql/) — ask the same questions
  yourself against `model.db`.
- [The navigator](/docs/explanation/navigator/) — why there is one classified row per
